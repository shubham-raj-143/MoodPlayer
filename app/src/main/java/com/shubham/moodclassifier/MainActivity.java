...
public class MainActivity extends AppCompatActivity {
    private AnimationDrawable animationDrawable_toolbar;
    ImageView imageView;
    ImageButton btnCamera, btnemo, btnplay;
    TextView tv;
    Bitmap croppedbmp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar=findViewById(R.id.dark_toolbar);
        toolbar.setTitle("Mood Player");
        setSupportActionBar(toolbar);

//        //============ANIMATED TOOLBAR===========
//        animationDrawable_toolbar = (AnimationDrawable) toolbar.getBackground();
//        // setting enter fade animation duration to 5 seconds
//        animationDrawable_toolbar.setEnterFadeDuration(250);
//        // setting exit fade animation duration to 2 seconds
//        animationDrawable_toolbar.setExitFadeDuration(2250);
    ...
    private void initViews()
    {
        ...
        btnemo = (ImageButton)findViewById(R.id.btnemo);
        ...
        btnCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count++;
                imageView.setImageDrawable(getResources().getDrawable(R.drawable.face_scan));
    ...
    protected void onResume() {
        super.onResume();
        if (animationDrawable_toolbar != null && !animationDrawable_toolbar.isRunning()) {
            // start the animation
            animationDrawable_toolbar.start();
        }
    }
    @Override
    protected void onPause() {
        ...
        if (animationDrawable_toolbar != null && animationDrawable_toolbar.isRunning()) {
            // stop the animation
            animationDrawable_toolbar.stop();
        }
    }
